...
import { Badge, Title, Text, Group, Paper, Grid, Stack, Anchor } from "@mantine/core";
  ...
  return (
    <div>
      <Link href="/account/orders" style={{ textDecoration: "none" }}>
        <Anchor c="dimmed" size="sm" mb="md" display="inline-flex" style={{ alignItems: "center", gap: 4 }}>
